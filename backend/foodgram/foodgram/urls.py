...
urlpatterns = [
    ...
    path(
        r"api/recipes/download_shopping_cart/",
        ShoppingCartRenderView.as_view(),
        name="shopping_cart",
    ),
    path(
        r"api/users/subscriptions/",
        SubscriptionsView.as_view(),
        name="subscriptions",
    ),
    path("api/", include(router_api.urls)),
    path(
        r"api/recipes/<recipe_id>/favorite/",
        FavoritesView.as_view(),
        name="favorite",
    ),
    path(
        r"api/recipes/<recipe_id>/shopping_cart/",
        ShoppingCartView.as_view(),
        name="shopping_cart",
    ),
    path(
        r"api/users/<user_id>/subscribe/",
